...
def makeIndexHtml():
    ...
    for func in funcs:
        link = proto + root_dir + func_alias[index]
        index += 1
        htmlFile.write("\t<a href=\"" + link + ".html\" title=\"LISP Function (" + func + ")\">(" + func + ")</a><br/>\n")
